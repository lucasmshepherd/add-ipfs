...
export default function MintNft(props) {
  ...
  let price = count_3 * PRICE_THREE * 10**18;
        if (count_3 > TRANSACTION_LIMIT) {
            setError("Can't mint more than " + TRANSACTION_LIMIT + " NFTs");
        } else {
    ...
    <> 
      <div className={styles.mint} id={tierText}>
        ...
        <div className={styles.text}>
          ...
          <hr/>
          <br/>
          <small><i>* Required: 100k ADD Holdings</i></small><br/>
          <small><i>* Required: Follow @fundanarcy on Twitter</i></small><br/><br/>
