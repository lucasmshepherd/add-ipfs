...
export default function MintNft(props) {
  ...
  useEffect(() => {
    ...
    if (limitPerTrx > mintLimit) {
      ...
      setCount_2(mintLimit)
      setCount_3(mintLimit)
    }
    if (mintLimit == 0) {
      setMintEnableBtn(false)
      setMintButton_1(false)
  ...
  }, [SALE_MINTED_ONE, SALE_MINTED_THREE, SALE_MINTED_TWO, SALE_NFT_ONE, SALE_NFT_THREE, SALE_NFT_TWO, mintLimit, limitPerTrx, limitPerWallet])
