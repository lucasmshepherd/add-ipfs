    ...
    <> 
      <div className={styles.wrapper}>
        <div className={styles.social}>
          <a href="mailto:info@fundanarchy.io" rel="noreferrer" className={styles.link} onClick={soundEffect}>
          ...
          <a href="https://t.me/anarchistdevelopmentdao" target="_blank" rel="noreferrer" className={styles.link} onClick={soundEffect}>
