    ...
    <> 
      <div className={styles.wrapper}>
        <div className={styles.social}>
          <a href="https://www.dextools.io/app/en/ether/pair-explorer/0x8fead6e1be5af7b5beda08688018d55079e6de35" target="_blank" rel="noreferrer" className={styles.link} onClick={soundEffect}>
