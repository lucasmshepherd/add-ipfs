      ...
      <div data-connected={active} className={styles.balance}>
        ...
        <span title="ADD Balance">
          {active ? 
            <>
              {balance <= 1 ?
                <a href='https://app.uniswap.org/#/swap?inputCurrency=0x6542c8f90915a57314f4167b81851a3cd731c6e2&outputCurrency=ETH' target='_blank' rel='nofollower'>Purchase ADD</a>
                :
                bal
              }
            </>
