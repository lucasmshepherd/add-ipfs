    ...
    <>
      ...
      <div className={styles.sidebyside}>
        <div className={styles.content}>
          ...
          <p>$ADD tokenholders are the collective authority whom make decisions for the DAO <i>through voting</i>. </p>
          <h3>History</h3>
          ...
          <p>Our core principles are <i>trust</i>, free and open markets, private ownership of property and capital, and the complete abolishment of legacy financial systems.</p>
