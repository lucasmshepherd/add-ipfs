...
export default function Admin(props) {
  ...
  const data2 = {
    datasets: [{
      data: [totalVoters - voteNo - 312, voteNo, 312],
      cutout: [
        '22'
      ],
      labels: [
  ...
  const data3 = {
    datasets: [{
      data: [totalVoters - 50 - 312, 50, 312],
      cutout: [
        '22'
      ],
      labels: [
