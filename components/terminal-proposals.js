...
export default class Terminal extends React.Component {
  componentDidMount () {
    ...
    var text = ["----------------------------------------------<br/>User: Unknown<br/><b>Before you can vote, you must assign your voting rights to either yourself, or you can assign it to a third party.</b><br/>----------------------------------------------<br/>1 Submit<br/>2 Pending<br/>3 Closed<br/><b>4 Delegate Votes</b><br/>$> ", ""];
    var commandHistory = [];
    var lineY = 1;
    var index = 0;
    var historyIndex = 0;
