...
export default class Terminal extends React.Component {
  componentDidMount () {
    ...
    var text = ["----------------------------------------------<br/>User: Unknown<br/><b>Before you can vote, you must assign your voting rights to either yourself, or you can assign it to a third party.</b><br/>----------------------------------------------<br/>By delegating your voting rights, you allow the recipient user to vote any decision on a proposal without your consent, however you can take back your rights by entering your address above and delegating back to yourself. The recipient does not take any ownership of your dCULT tokens.<br/>----------------------------------------------<br/>Enter the Ethereum address of wallet to receive the voting rights:<br/>$> ", ""];
    var commandHistory = [];
    var lineY = 1;
    var index = 0;
    var historyIndex = 0;
